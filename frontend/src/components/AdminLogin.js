...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 via-indigo-400 to-blue-300 py-8 px-2">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-6 sm:p-10 flex flex-col items-center transition-all duration-300 border border-indigo-100">
        <div className="flex flex-col items-center w-full mb-4">
          <img src={logoUrl} alt="Travello Logo" className="w-20 h-20 mb-2 object-contain rounded-full border-2 border-indigo-200 bg-white shadow" onError={e => {e.target.onerror=null;e.target.src='https://placehold.co/80x80?text=Logo';}} />
          <h2 className="text-3xl font-extrabold text-indigo-800 mb-1 text-center tracking-tight">Admin Login</h2>
        </div>
        <p className="text-indigo-600 text-center mb-6 w-full text-base">
          Not an admin?{' '}
          <Link to="/login" className="text-blue-700 hover:underline font-semibold">User Login</Link>
        </p>
        <form className="w-full space-y-4" onSubmit={handleSubmit} autoComplete="off">
          <div className="relative">
            ...
            <input
              ...
              autoComplete="email"
              required
              className="pl-10 pr-4 py-2 w-full border border-indigo-200 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 text-gray-800 placeholder-indigo-300 bg-indigo-50 transition"
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              className="pl-10 pr-10 py-2 w-full border border-indigo-200 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 text-gray-800 placeholder-indigo-300 bg-indigo-50 transition"
            ...
            <button
              type="button"
              className="absolute right-3 top-1/2 transform -translate-y-1/2 text-indigo-400 hover:text-indigo-600 focus:outline-none"
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center text-sm text-indigo-700">
              <input
                ...
                onChange={handleChange}
                className="form-checkbox h-4 w-4 text-indigo-600 rounded focus:ring-indigo-500 border-indigo-200"
              />
              <span className="ml-2">Remember me</span>
            </label>
            <Link to="/forgot-password" className="text-sm text-indigo-700 hover:underline font-medium">Forgot Password?</Link>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 px-4 mt-2 rounded-xl bg-gradient-to-r from-indigo-600 to-blue-500 text-white font-bold text-lg shadow-lg hover:from-indigo-700 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
